...
@section('groupcontent')
	...
	<div class="headerbuttonbar" style="">
		<div class="pull-left">
			<ul class="nav nav-pills">
				<li class="active"><a href="{{ url('groups/ryanai/quizzes') }}">New</a></li>
				<li><a href="{{ url('groups/ryanai/quizzes/taken') }}">Taken</a></li>
			</ul>
		</div>
	...
	<div class="panel panel-danger">
		<div class="panel-heading">
			<h3 class="panel-title">Quiz by <a href="#">Keshavan Ravi</a></h3>
		</div>
		<div class="panel-body">
			This quiz covers the following topics in our Artificial Intelligence class: Search.<br/><br/>
			<a href="{{ url('groups/ryanai/takequiz') }}" class="btn btn-primary btn-sm">Take Quiz</a> &nbsp;&nbsp;&nbsp;<strong><small>Already taken by 2 group members</small></strong>
		</div>
	</div>
	<!--<div class="panel panel-danger">
		<div class="panel-heading">
